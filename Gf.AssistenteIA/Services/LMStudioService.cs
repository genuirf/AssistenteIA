...
namespace Gf.AssistenteIA.Services
{
    public class LMStudioService : IAssistenteService
    {
        ...
        private static string url_completions = "/v1/chat/completions";
        private static string url_embeddings = "/v1/embeddings";
        ...
        private Body GetBody(string questao, List<MensagemModel> historico, string? contextEmbedding, double temperature, int max_tokens, string model_name)
        {
            var body = new Body();
        ...
        {
            var body = GetBody(questao, historico, contextEmbedding, assistente.Temperature, assistente.MaxTokens, assistente.ModelName);
